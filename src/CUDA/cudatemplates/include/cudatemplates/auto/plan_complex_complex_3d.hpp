...
#ifndef CUFFT_COMPLEX_COMPLEX_3D_H
#define CUFFT_COMPLEX_COMPLEX_3D_H
...
public:
  ...
  */
  ...
  {
    CUFFT_CHECK(cufftPlan3d(&plan, size[0], size[1], size[2], CUFFT_C2C));
  }
  ...
  */
  ...
  {
    CUFFT_CHECK(cufftPlan3d(&plan, size0, size1, size2, CUFFT_C2C));
  }
