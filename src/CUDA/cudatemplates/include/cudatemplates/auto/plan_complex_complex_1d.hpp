...
#ifndef CUFFT_COMPLEX_COMPLEX_1D_H
#define CUFFT_COMPLEX_COMPLEX_1D_H
...
public:
  ...
  */
  ...
  {
    CUFFT_CHECK(cufftPlan1d(&plan, size[0], CUFFT_C2C, batch));
  }
  ...
  */
  ...
  {
    CUFFT_CHECK(cufftPlan1d(&plan, size0, CUFFT_C2C, batch));
  }
