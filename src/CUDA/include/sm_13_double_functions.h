...
__device_func__(float __internal_double2float_kernel(double a))
{
...
__device_func__(double __internal_ll2double_kernel(long long int a, enum cudaRoundMode rndMode))
{
...
__device_func__(double __internal_ull2double_kernel(unsigned long long int a, enum cudaRoundMode rndMode))
{
  volatile union __cudart_DoubleUlonglongCvt res;
  int shift;
  unsigned int t;
...
__device_func__(long long int __internal_double2ll_kernel(double a, long long int max, long long int min, long long int nan, enum cudaRoundMode rndMode))
{
...
__device_func__(unsigned long long int __internal_double2ull_kernel(double a, unsigned long long int max, unsigned long long int nan, enum cudaRoundMode rndMode))
{
  volatile union __cudart_DoubleUlonglongCvt xx, res;
  unsigned long long int t = 0;
  int shift;
...
#if !defined(__CUDABE__) || defined(CUDA_NO_SM_13_DOUBLE_INTRINSICS)
#include "common_types.h"
__device_func__(double __internal_fma_kernel(double x, double y, double z, enum cudaRoundMode rndMode))
{
...
__device_func__(double __fma_rn(double x, double y, double z))
{
  return __internal_fma_kernel(x, y, z, cudaRoundNearest);
}

__device_func__(double __fma_rd(double x, double y, double z))
{
  return __internal_fma_kernel(x, y, z, cudaRoundMinInf);
}

__device_func__(double __fma_ru(double x, double y, double z))
{
  return __internal_fma_kernel(x, y, z, cudaRoundPosInf);
}

__device_func__(double __fma_rz(double x, double y, double z))
{
  return __internal_fma_kernel(x, y, z, cudaRoundZero);
}

__device_func__(double __dadd_rz(double a, double b))
{
  return __fma_rz(a, CUDART_ONE, b); 
}

__device_func__(double __dadd_ru(double a, double b))
{
  return __fma_ru(a, CUDART_ONE, b); 
}

__device_func__(double __dadd_rd(double a, double b))
{
  return __fma_rd(a, CUDART_ONE, b); 
}

__device_func__(double __dmul_rz(double a, double b))
{
  return __fma_rz(a, b, CUDART_NEG_ZERO); 
}

__device_func__(double __dmul_ru(double a, double b))
{
  return __fma_ru(a, b, CUDART_NEG_ZERO); 
}

__device_func__(double __dmul_rd(double a, double b))
{
  return __fma_rd(a, b, CUDART_ZERO); 
}

__device_func__(double __dadd_rn(double a, double b))
{
  return __fma_rn(a, CUDART_ONE, b); 
}

__device_func__(double __dmul_rn(double a, double b))
{
  return __fma_rn(a, b, CUDART_NEG_ZERO); 
}

#endif /* !__CUDABE__ || CUDA_NO_SM_13_DOUBLE_INTRINSICS */
