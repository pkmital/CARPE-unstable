...
# ADD LINK32 kernel32.lib user32.lib comdlg32.lib shell32.lib /nologo /subsystem:console /machine:I386 /out:"../bin/TestWinGlut.exe" /libpath:"../lib/"
...
# ADD LINK32 kernel32.lib user32.lib comdlg32.lib shell32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../bin/TestWinGlut_d.exe" /pdbtype:sept /libpath:"../lib/"
