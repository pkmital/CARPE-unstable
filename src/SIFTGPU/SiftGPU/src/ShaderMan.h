...
public:
	...
	static void UseShaderMarginCopy(float xmax, float ymax);
	static void UseShaderCopyTexCoord();
	static void UseShaderOrientation(int gtex, int width, int height, float sigma, int stex, float step);
	static void UseShaderDescriptor(int gtex, int dwidth, int fwidth, int width, int height, float sigma);
	static void UseShaderSimpleOrientation(int oTex, float size);
	static void UseShaderListReshapeInit();
	static void UseShaderListReshapeStart(float width);
	static void UseShaderListReshapeStep(int tex0, int dx, int dy);
	static void UseShaderListReshapeEnd(int fTex, int oTex);
	static void UseShaderCopyKeypoint();
	static void UseShaderGenVBO( float width, float fwidth,  float size);
	static void UseShaderDisplayGradYABS();
	static void UseShaderDisplayGradXABS();
	static void UseShaderDisplayDOGABS();
	...
	static void UseShaderGenListEnd();
	...
	static void UseShaderDogZpass();
	static void UseShaderDogPass2(int texU, int texD);
	static void UseShaderDogPass1();
	static void UseShaderKeypoint(int texU, int texD);
	static void UseShaderGradientPass();
	static void LoadDogShaders(float dog_threshold, float edge_threshold);
	static void UseShaderDisplayKeypoints();
	static void UseShaderDisplayGradY();
	static void UseShaderDisplayGradX();
