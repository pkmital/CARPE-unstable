...
int main( int argc, char** argv)
{
  try {
    ...
    flowlib.setVerbose(0);
    flowlib.setNumImages(2);
    flowlib.setModel(CudaFlowLib::HL1);
    flowlib.setLambda(50.0f);
    flowlib.setGaussTVEpsilon(0.01f);
    flowlib.setNumIter(50);
    flowlib.setNumWarps(10);
    flowlib.setNumScales(100); // reduced automatically if too high...
    flowlib.setScaleFactor(0.8f);
    flowlib.useDiffusionTensor(true);
    flowlib.setDiffusionAlpha(5.0f);
    flowlib.setDiffusionQ(0.5f);
