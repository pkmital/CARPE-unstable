...
bool iClearVolume(Cuda::DeviceMemory<unsigned char, 3>& volume);
bool iClearVolume(Cuda::DeviceMemory<float, 3>& volume);
...
bool iRandomNumbers(Cuda::DeviceMemory<float,3> *data, const float a, const float b);
...
// variant for color 2d images
bool iGaussianConvolution(Cuda::DeviceMemoryPitched<float, 3> *data, float sigma, unsigned int kernelsize);

// variant for single channel 3d images
bool iGaussianConvolution3D(Cuda::DeviceMemoryPitched<float, 3> *data, float sigma, unsigned int kernelsize);

bool iMedianFilter3x3(const Cuda::DeviceMemoryPitched<float, 2> &input, Cuda::DeviceMemoryPitched<float, 2> &output);

bool iMedianFilter3x3x3(const Cuda::DeviceMemoryPitched<float, 3> &input,
                        Cuda::DeviceMemoryPitched<float, 3> &output,
                        const bool forceXYSliceFilteringOnly);
...
bool iEdgeDetectionSimoncelli3D(const Cuda::DeviceMemory<float, 3> *input,
                                Cuda::DeviceMemory<float, 3> *output,
...
bool iRegionGrowing( Cuda::DeviceMemory<unsigned char, 3> *region,
                     ...
                     unsigned char absolute_intensity_range_low,
                     unsigned char absolute_intensity_range_high);

bool iRegionGrowing( Cuda::DeviceMemory<unsigned char, 3> *region,
                     Cuda::DeviceMemory<float, 3> *image,
                     float absolute_intensity_range_low,
                     float absolute_intensity_range_high);
...
bool iDrawCube(Cuda::DeviceMemory<float, 3> *image, int x_start, int y_start, int z_start,
               int x_end, int y_end, int z_end, int line_width, float intensity);
bool iDrawSphere3D(Cuda::DeviceMemory<float, 3> *image, int x_center, int y_center, int z_center,
